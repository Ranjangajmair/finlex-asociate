/* --------------------------------------------------
 * © Copyright 2024 - Justica by Designesia
 * --------------------------------------------------*/
(function ($) {
    'use strict';
    ...
    var mobile_menu_show = localStorage.getItem('mobile_menu_show') === '1' ? 1 : 0;
    var v_count = '0';
    var mb;
    var instances = [];
    var $window = $(window);
    ...
    jQuery(document).ready(function () {
        ...
        jQuery('#menu-btn').on("click", function () {
            ...
            localStorage.setItem('mobile_menu_show', mobile_menu_show); // Save the state in localStorage
        });
        ...
        jQuery('#mainmenu li a').on("click", function () {
            ...
            mobile_menu_show = 0;
            localStorage.setItem('mobile_menu_show', mobile_menu_show); // Update localStorage
        });
